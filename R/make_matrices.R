...
#'
#' @param model_traits A character vector of traits, e.g. `c("sus", "inf", "tol)`
#' @param use_traits A string with the first letter of each trait being used, e.g. `sit`
...
#' - a named list e.g. `list(si = 0.3, st = -0.2, default = 0)`
#' @returns A list containing Sigma matrices (for BICI) and covariance matrices (for R)
#' @export
#'
#' @examples
#' out <- make_matrices(model_traits, "sit",
#'                      vars = list(sus = 1, inf = 1.5, default = 0),

...
#'
#' @param dataset Name of the datasets
#' @param name Name of the run (e.g. "scen-1-1")
#' @param bici_cmd bici_cmd: where do the output of BICI's simulations come from?
...
#'
#' @returns An R list containing all BICI information
#' @export
